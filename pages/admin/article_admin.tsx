...
export default function ArticleAdmin() {
  ...
  let token="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjcwOTY0MDg0LCJqdGkiOiI5YjE0YzdhNmYzOWY0MTI5YjU4MTdmZTJlNTM2ZTQ5NCIsInVzZXJfaWQiOjF9.EwJy_Q05UlsG3lvqpK0_V5bMI5StYz3XRyR21-qrf18"
...
const stringifiedData = useMemo(() => {
  ...
  // const parsed = JSON.parse<ArticleList>(json)  ;
  // console.log("articleparsed  "+parsed)
  // return parsed;
}, [data]);
